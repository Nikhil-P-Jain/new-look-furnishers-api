const{createpurchase_order,getpurchase_order,getpurchase_orderbyid,updatepurchase_order,deletepurchase_order,getpurchase_orderbyproductid}=require("./purchase_order.controller");
...
router.get("/getpurchase_orderbyproductid/:id",getpurchase_orderbyproductid);
